...
public class PicObjNotRotation : UdonSharpBehaviour
{
	...
	private void Update()
	{
		...
		if (DorV == false)
		{
			...
			transform.rotation = m_owner.GetTrackingData(VRCPlayerApi.TrackingDataType.Head).rotation * Quaternion.Inverse(lateH) * lateRot;
	...
	public override void Interact()
	{
		...
		lateH = m_owner.GetTrackingData(VRCPlayerApi.TrackingDataType.Head).rotation;
